...
function Weapon(option)
{
    ...
    this.oneHanded=option.oneHunded || false;
...
var Bolter=new Weapon({
    name:'Bolter',
    description:'Standart two-handed spacemarine weapon, usefull and power',
    range:4,
    strength:4,
    AP:4,
    attackCount:2,
...
var BattleKnife=new Weapon({
    name:'Battle knife',
    description:'Standart one-hunded melee weapon',
    range:0,
    strength:4,
    AP:5,
    attackCount:0,
...
var ChainSword=new Weapon({
    name:'Chain sword',
    description:'One-hunded melee weapon, which cuts the enemy in small pieces',
    range:0,
    strength:5,
    AP:5,
    attackCount:0,
...
Weapon=[BattleKnife,ChainSword,BoltPistol,Bolter];
