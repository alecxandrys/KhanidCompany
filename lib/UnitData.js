 ...
 * TODO:Commander, condition, price, rules, type:Ranged||Melee need to rebuild
 */
...
var BattleKnife=new Weapon({
    name:'Battle knife',
    description:'Standard one-handed melee weapon',
    cost:2,
    range:0,
    strength:4,
    AP:5,
...
var Marine=new Squad({
    ...
    leadership:8,
    armorSave:3,
    availableWeapon:[BattleKnife,ChainSword,BoltPistol,Bolter]
});
var Devastator=new Squad({
    ...
    leadership:8,
    armorSave:3,
    availableWeapon:[BattleKnife,BoltPistol,Bolter,HeavyBolter]
});
var Scout=new Squad({
    name:'Scout',
    ...
    leadership:7,
    armorSave:4,
    availableWeapon:[BattleKnife,BoltPistol,Bolter]
});
