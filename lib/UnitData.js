...
var Marine=new Squad({
    ...
    leadership:8,
    armorSave:3,
    availableWeapon:['SpaceMarine','Usual','Ranged','Melee','Two-handed']
});
var Devastator=new Squad({
    ...
    leadership:8,
    armorSave:3,
    availableWeapon:['SpaceMarine','Usual','Ranged','Two-handed','Heavy']
});
var Scout=new Squad({
    name:'Scout',
    ...
    leadership:7,
    armorSave:4,
    availableWeapon:['SpaceMarine','Usual','Ranged','Two-handed']
});
