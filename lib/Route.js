...
function notComm()
{
    ...
    var checkID=battles.find({_id:battleID});
    var chk=checkID.count();
    //TODO make log normal and fix error when multiple refresh
...
//Router.onBeforeAction(onBattle,{});//hook that must redirect on field if reopen window.//this block is unnecessary?
