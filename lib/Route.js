    ...
    if (chk==1)
        {
            switch (name)
            {
                case name1:{console.log(name+" "+name1);this.next();break;}
                case name2:{console.log(name+" "+name2);this.next();break;}
                default :{console.log(name1+" "+name2+" and you are:"+Meteor.user().username+" do not equals");this.render('Main');}
            }
